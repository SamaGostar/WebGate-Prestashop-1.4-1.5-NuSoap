...
class zarinpalwg extends PaymentModule {
	...
	public function install() {
		if (!parent::install() ||
			!Configuration::updateValue('zarinpalwg_API', '') ||
			!Configuration::updateValue('zarinpalwg_LOGO', '') ||
			!Configuration::updateValue('zarinpalwg_HASH_KEY', $this->hash_key()) ||
	...
	public function uninstall() {
		if (!Configuration::deleteByName('zarinpalwg_API') ||
			!Configuration::deleteByName('zarinpalwg_LOGO') ||
			!Configuration::deleteByName('zarinpalwg_HASH_KEY') ||
			!parent::uninstall())
			return false;
		else
			return true;
	...
	public function do_payment($cart) {
		...
		$mobile='0';
		$email='0';
		$params = array("merchant_id" => $ZarinpalPin,
			"amount" => $amount,
